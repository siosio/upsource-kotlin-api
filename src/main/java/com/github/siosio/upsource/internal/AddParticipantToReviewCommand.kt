...
class AddParticipantToReviewCommand(private val participantInReviewRequest: ParticipantInReviewRequest) : Command<ParticipantInReviewRequest, VoidMessage> {

  override val name: String = "addParticipantToReview"
